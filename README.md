...
### Q4: 遇到问题如何解决？
**A:** 可以：
1. 查看 [常见错误文档](docs/common-errors.md)
2. 搜索相关问题
3. 提交 [GitHub Issue](https://github.com/Steve-1219/c-learning/issues)
...
gantt
    ...
    section 基础阶段
    环境配置与Hello World :done, 2024-01-01, 3d
    变量与数据类型       :done, 2024-01-04, 5d
    控制结构           :done, 2024-01-09, 5d
    section 核心阶段
    函数与数组         :active, 2024-01-14, 7d
    指针专题           :2024-01-21, 7d
    字符串处理         :2024-01-28, 5d
    section 项目实战
    计算器项目         :2024-02-02, 5d
    学生管理系统       :2024-02-07, 7d
    文件管理器         :2024-02-14, 7d
```
